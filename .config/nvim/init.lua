...
require("config.autocmd-assembly")
require("config.autocmd-bash")
require("config.autocmd-c")
require("config.autocmd-gdscript")
require("config.autocmd-html-css")
require("config.autocmd-js")
require("config.autocmd-lua")
require("config.autocmd-makefile")
require("config.autocmd-markdown")
require("config.autocmd-python")
require("config.autocmd-rust")
